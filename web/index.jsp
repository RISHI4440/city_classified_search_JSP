...
<li><a href="register.jsp" class="ex">Sign Up</a></li>
<li><a href="login.jsp" class="ex">Login</a></li>
<li><a href="details.jsp" class="ex">Search</a></li>
<li><a href="viewclassified.jsp" class="ex">View classified</a></li>
<li><a href="admin.jsp" class="ex">Admin</a></li>
	...
	<%@ include file="coockie.jsp" %>
		<h3 class="title" ><a href="#">Welcome To City Classified and Search Project</a></h3>
		<div class="entry">
